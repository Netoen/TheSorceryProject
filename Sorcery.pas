...
type
  TForm1 = class(TForm)
    ...
    Silver: TMenuItem;
    Sky: TMenuItem;
    TabletLight: TMenuItem;
    TabletDark: TMenuItem;
    Windows: TMenuItem;
    Windows10: TMenuItem;
    Windows10Blue: TMenuItem;
    Windows10Dark: TMenuItem;
    Windows10Green: TMenuItem;
    Windows10Purple: TMenuItem;
    Windows10StaleGray: TMenuItem;
    Windows1: TMenuItem;
...
begin
  ...
  writeln(f, Stat1_Max);
  writeln(f, Stat2_Max);
  writeln(f, Label_Stat1.Caption); // at the end for sake of back compability
  writeln(f, Label_Stat2.Caption);
end;
...
begin
 try
  ...
  if a<>'' then
   begin
   Label_Stat1.Caption := a;
   end
   else
     Label_Stat1.Caption := 'Stat 1';
  readln(f, a);
  if a<>'' then
   begin
   Label_Stat2.Caption := a;
   end
   else
     Label_Stat2.Caption := 'Stat 2';
 except
   on E : Exception do
...
begin
 try
  ...
  Rewrite(f);       { TODO : remember user's save file and restore after }
...
begin
  ShowMessage('Program version 2.2.0.0 from 13.04.2019' +
              #13 + 'Load {should be} compatible since version: 1.4.2.0' +
...
begin
// if Form5.FileSaveDialog1.FileNameLabel then
